...
public:
        ...
        const restinio::request_handle_t& req, rr::route_params_t ) const
    {
        ...
        resp.append_header(restinio::http_field::cache_control, "no-cache, no-store, must-revalidate");
        resp.append_header(restinio::http_field::pragma, "no-cache");
        resp.append_header(restinio::http_field::expires, "0");
